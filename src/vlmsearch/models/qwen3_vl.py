...
class Qwen3_VL(lmms):
    """
    Wraps a Qwen3_VL model for single-step generation 
        ...
        **kwargs,
        ...
        if use_flash_attention_2 and (self.generate_attention_map == False):
            ...
            if self.generate_attention_map:
                self._model = Qwen3VLForConditionalGeneration.from_pretrained(pretrained, torch_dtype="auto", device_map=self.device_map, attn_implementation="eager").eval()
            else:
