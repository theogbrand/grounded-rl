...
NUM_GPUS=4  # 235B FP8 needs 4 GPUs minimum (can use more if available)
NUM_PROCESSES=10
dataset="web_grounding" # sat2, web_grounding, vstar, web_action
PORT=9002 # port for vllm server
